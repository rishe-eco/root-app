...
type Slot = { key: 'about' | 'studio' | 'cast' | 'journey'; to?: string };

/**
 * Four nav slots: one real, three locked. A locked slot shows that a section
 * exists there — the label rendered blurred with the padlock on top — without
 * pretending it is ready. `.sr-only` carries the meaning for screen readers.
 */
const SLOTS: Slot[] = [
  { key: 'about', to: '/about' },
  { key: 'studio' },
